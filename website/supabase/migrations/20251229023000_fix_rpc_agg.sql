...
BEGIN
  ...
  ELSE
    ...
    -- FIX: Select the column 'val' specifically to avoid wrapping in {"value":...}
    SELECT jsonb_agg(t.val) INTO v_decisions
    FROM (
      SELECT jsonb_array_elements(v_pack.decisions) as val
